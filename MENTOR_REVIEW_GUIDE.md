...
| **8. Automated Quality Suite** | Run single-command health check | Terminal: `npm test` or double-click `scripts/verify.bat` | **101/101 automated assertions passing 100%** across schema, clinical math, and localization. |
