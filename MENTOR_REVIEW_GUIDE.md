...
| **8. Automated Quality Suite** | Run single-command health check | Terminal: `npm test` or double-click `scripts/verify.bat` | **80/80 automated assertions passing 100%** across schema, clinical math, and localization. |
...
- **Automated Verification**: `npm test` runs 80 assertions across file integrity, local JSON DB, drug conflict heuristics, and bilingual token parity.
